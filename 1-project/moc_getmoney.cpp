...
QT_MOC_LITERAL(1, 9, 6), // "PAYEND"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 8), // "down_pic"
QT_MOC_LITERAL(4, 26, 19), // "on_updataBt_clicked"
QT_MOC_LITERAL(5, 46, 18) // "on_buyedBt_clicked"

    },
    "getMoney\0PAYEND\0\0down_pic\0on_updataBt_clicked\0"
    "on_buyedBt_clicked"
};
...
void getMoney::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        getMoney *_t = static_cast<getMoney *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->PAYEND(); break;
        case 1: _t->down_pic(); break;
        case 2: _t->on_updataBt_clicked(); break;
        case 3: _t->on_buyedBt_clicked(); break;
        default: ;
        }
        ...
        {
            typedef void (getMoney::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&getMoney::PAYEND)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject getMoney::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_getMoney.data,
      qt_meta_data_getMoney,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *getMoney::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_getMoney.stringdata0))
        return static_cast<void*>(const_cast< getMoney*>(this));
