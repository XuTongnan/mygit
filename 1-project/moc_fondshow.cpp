...
QT_MOC_LITERAL(4, 18, 16), // "on_addBt_clicked"
QT_MOC_LITERAL(5, 35, 18) // "on_addBt_2_clicked"

    },
    "fondShow\0ADD\0\0SUB\0on_addBt_clicked\0"
    "on_addBt_2_clicked"
};
...
void fondShow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        fondShow *_t = static_cast<fondShow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ADD(); break;
        case 1: _t->SUB(); break;
        case 2: _t->on_addBt_clicked(); break;
        case 3: _t->on_addBt_2_clicked(); break;
        default: ;
        }
        ...
        {
            typedef void (fondShow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&fondShow::ADD)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (fondShow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&fondShow::SUB)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject fondShow::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_fondShow.data,
      qt_meta_data_fondShow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *fondShow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_fondShow.stringdata0))
        return static_cast<void*>(const_cast< fondShow*>(this));
