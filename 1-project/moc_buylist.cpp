...
QT_MOC_LITERAL(3, 27, 16) // "on_buyBt_clicked"

    },
    "buyList\0on_backBt_clicked\0\0on_buyBt_clicked"
};
...
void buyList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        buyList *_t = static_cast<buyList *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_backBt_clicked(); break;
        case 1: _t->on_buyBt_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject buyList::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_buyList.data,
      qt_meta_data_buyList,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *buyList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_buyList.stringdata0))
        return static_cast<void*>(const_cast< buyList*>(this));
